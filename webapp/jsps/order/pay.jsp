...
<div class="divBank">
	...
	<div style="margin: 40px;">
		...
		<a href="<c:url value='/OrderServlet?oper=findOrderByUid'></c:url>" class="linkNext">稍后支付</a>
	</div>
</div>
</form>
  </body>
